//Bei dieser Bibliothek ist es nicht notwendig die Temperatur auch auszulesen.
//Standardmäßig ist die Bibliothek so konfiguriert das die Messung des Drucks schnell(5ms) dafür relativ ungenau ist. Für uns aber immer noch genau genug +-1m
// Ist notwendig für die I2C Kommunikation
#include <Wire.h>
...
void setup()
{
  ...
  if(barometer.EnsureConnected())
  {
    ...
    //barometer.SetResolution(0,0); //braucht man nicht nur wenn man die genauigkeit erhöhen möchte. (3,0) wäre am genauesten aber benötigt 26ms
  }
  else
  { 
